...
to setup
  clear-all
  let lista_color sublist [red orange yellow green turquoise cyan blue violet magenta pink] 0 grupos
  create-turtles round((world-width * world-height) * densidad)[
    set color one-of lista_color
    set size 0.75
...
to go
  ...
  ask turtles [
    if not feliz?[move-to one-of patches with [not any? turtles-here]]
  ]
